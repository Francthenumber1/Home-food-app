...
namespace HomeFoodRegistration
{
    public partial class RegistrationForm : Form
    {
            ...
            using (var connection = new SQLiteConnection(connectionString))
            {
                ...
                using (var command = new SQLiteCommand(query, connection))
                {
                    ...
                    try
                    {
                        ...
                        // Setze DialogResult auf OK und schließe das Registrierungsformular
        ...
        // In RegistrationForm.cs
        private void RegistrationForm_Load(object sender, EventArgs e)
        {
            // Implementiere Logik für das Laden des Formulars
        }

        private void labelName_Click(object sender, EventArgs e)
        {
            // Implementiere Logik für das Klicken auf das Label
        }
    }
}
